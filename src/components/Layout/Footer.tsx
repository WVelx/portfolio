...
function Footer() {
  return (
    <footer className="relative z-30 text-center md:text-base text-sm">
      <div className="xl:container p-4 shadow-sm shadow-lightTexttitle/10 dark:shadow-darkTexttitle/10 bg-lightBackground text-lightTexttitle dark:bg-darkBackground dark:text-darkTexttitle">
          <Line_gradient />
